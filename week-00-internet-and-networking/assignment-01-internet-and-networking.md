...
![Task 1 Screenshot](screenshots/<img width="1920" height="1080" alt="Screenshot (622)" src="https://github.com/user-attachments/assets/a0235e30-6e7a-4b28-acbf-66d078ff2b54" />
)
...
I learned that a network protocol is a set of rules that helps devices communicate and exchange data with each other. I understood it better by comparing it to real-life communication, where people follow common rules to understand each other.
...
![Application Architecture Diagram](screenshots/<img width="1536" height="1024" alt="image" src="https://github.com/user-attachments/assets/dfdceb1b-0ea4-44eb-ab1a-8ecb988f6aa5" />
)
...
DNS (Domain Name System) is like the Internet’s phonebook. It converts easy-to-remember domain names, such as `example.com`, into IP addresses that computers use to locate servers. To connect a domain directly to a given **IPv4 address**, an **A record** should be used. The A record maps a domain name to an IPv4 address, allowing users to access the website by entering the domain name instead of remembering the numerical IP address. If the given IP address is IPv6, an **AAAA record** would be used instead.
...
![VS Code Setup Screenshot](screenshots/<img width="1920" height="1080" alt="Screenshot (623)" src="https://github.com/user-attachments/assets/e90f181f-0238-4294-b719-078eb0b23b63" />
)
